...
public class InstagramClient {
    ...
    private final String postContentPath = "/me/media";
    private final String getAccessTokenPath = "/oauth/authorize";
    private final String publishContentPath = "/me/media_publish";
    ...
    public Optional<InstgramResponse> upload(InstagramRequest request , String accessToken) {
        ...
        try {
            ...
            log.error(" upload:HttpClientResponseException while calling the instagram for customer={} error ={}", request,errorMessage , hce);
    ...
    public Optional<String> getAccessToken(InstagramRequest request , String url , String tempToken){
        log.info("getAccessToken request received for instagram {}", request);
        try {
